module ThemeHelper
  # Determine initial theme class based on user preference or system settings
  # This is used in the application layout to set the initial theme
  def theme_class
    # You could potentially read from user preferences in the database
    # For now, we'll leave this implementation empty as it's handled client-side
    # via the theme/init.js script
    ""
  end
  # Helper to render theme toggle with appropriate icons
  def theme_toggle_button(options = {})
    button_classes = options[:class] || "p-2 text-gray-500 dark:text-gray-400 hover:text-primary-600 dark:hover:text-primary-400 rounded-full focus:outline-none transition-transform hover:scale-110"
    ...
    content_tag :button,
      ...
      concat icon("sun", class: "h-6 w-6 dark:block hidden", data: { theme_target: "lightIcon" })
      concat icon("moon", class: "h-6 w-6 dark:hidden block", data: { theme_target: "darkIcon" })
    end
  end
  ...
  def icon(name, options = {})
    ...
    icons = {
      ...
      "money-in" => '<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 9V7a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2m2 4h10a2 2 0 002-2v-6a2 2 0 00-2-2H9a2 2 0 00-2 2v6a2 2 0 002 2zm7-5a2 2 0 11-4 0 2 2 0 014 0z" /><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 19l-2-2m0 0l-2-2m2 2l2-2m-2 2l-2 2" />',
      "money-out" => '<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 9V7a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2m2 4h10a2 2 0 002-2v-6a2 2 0 00-2-2H9a2 2 0 00-2 2v6a2 2 0 002 2zm7-5a2 2 0 11-4 0 2 2 0 014 0z" /><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 14l2 2m0 0l2 2m-2-2l-2 2m2-2l2-2" />',
      ...
      "transport" => '<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7h12m0 0l-4-4m4 4l-4 4m0 6H4m0 0l4 4m-4-4l4-4" />',
      ...
      "empty-wallet" => '<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 10h18M3 14h18m-9-4v8m-7 0h14a2 2 0 002-2V8a2 2 0 00-2-2H5a2 2 0 00-2 2v8a2 2 0 002 2z" />',
      "empty-list" => '<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />',
      "repeat" => '<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 4v5h.582m15.356 2A8.001 8.001 0 004.582 9m0 0H9m11 11v-5h-.581m0 0a8.003 8.003 0 01-15.357-2m15.357 2H15" />',
  ...
  # Helper to get theme-aware class names - useful for conditional styling
  def theme_classes(light_classes, dark_classes)
    "#{light_classes} dark:#{dark_classes}"
  end
end
